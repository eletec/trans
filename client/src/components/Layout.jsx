...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors">
      {/* Header */}
      <header className="bg-gradient-to-r from-blue-800 to-blue-600 dark:from-gray-800 dark:to-gray-700 text-white shadow-lg">
      ...
      {/* Main content */}
      <main className="flex-1 max-w-[1800px] mx-auto w-full p-2 sm:p-4">
        {children}
      </main>
